    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    <a href="${pageContext.request.contextPath}/sys_assessmentDoc_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <s:iterator value="assessmentDocList" status="st">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_assessmentDoc_delete.action?assessmentDoc.id=<s:property value="id"></s:property>" class="btn btn-danger btn-sm btn-icon icon-left">
        ...
        <center>
            <a class="btn btn-default" href="${pageContext.request.contextPath}/sys_assessmentDoc_assessment_list.action">返回通知公告列表</a>
