...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post"  enctype="multipart/form-data"  action="${pageContext.request.contextPath}/sys_news_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">主页新闻标题</label>

                <div class="col-sm-5">
                    <input type="text" name="news.title" class="form-control" id="field-1" placeholder="请输入主页新闻标题">
                </div>
            </div>
            ...
            <label class="control-label">选择主页新闻展示图片</label>
