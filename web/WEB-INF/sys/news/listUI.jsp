        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_news_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_news_delete.action?news.id=<s:property value="id"></s:property>" class="btn btn-danger btn-sm btn-icon icon-left">
