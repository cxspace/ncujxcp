...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post"  enctype="multipart/form-data"  action="${pageContext.request.contextPath}/sys_news_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">主页新闻标题</label>

                <div class="col-sm-5">
                    <input type="text" name="news.title" value="<s:property value="news.title"></s:property>" class="form-control" id="field-1" placeholder="请输入主页新闻标题">
                </div>
            </div>

            <br>

            <label class="control-label">主页新闻内容</label>

            <br><br>

            <textarea name="news.content" id="editor" style="width: 100%;height: 360px;">
                <s:property value="news.content"></s:property>
            </textarea>

            <br>

            <s:hidden value="%{news.id}" name="news.id"></s:hidden>

            <s:hidden value="%{news.time}" name="news.time"></s:hidden>

            <s:hidden value="%{news.count}" name="news.count"></s:hidden>

            <s:hidden value="%{news.img}" name="news.img"></s:hidden>
