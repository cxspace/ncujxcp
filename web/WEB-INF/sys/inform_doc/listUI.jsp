...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_informDoc_delete.action?infoDoc.id=<s:property value="id"></s:property>" class="btn btn-danger btn-sm btn-icon icon-left">
        ...
        <center>
        <a class="btn btn-default" href="${pageContext.request.contextPath}/sys_informDoc_info_list.action">返回通知公告列表</a>
