...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered"  method="post" action="${pageContext.request.contextPath}/sys_dynamic_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">评估动态标题</label>

                <div class="col-sm-5">
                    <input type="text" name="dynamic.title" value="<s:property value="dynamic.title"></s:property>" class="form-control" id="field-1" placeholder="请输入评估动态标题">
                </div>
            </div>

            <br>

            <label class="control-label">评估动态内容</label>

            <br><br>

            <textarea id="editor" name="dynamic.content" style="width: 100%;height: 360px;">
                <s:property value="dynamic.content"></s:property>
            </textarea>
            ...
            <s:hidden value="%{dynamic.id}" name="dynamic.id"></s:hidden>

            <s:hidden value="%{dynamic.time}" name="dynamic.time"></s:hidden>

            <s:hidden value="%{dynamic.count}" name="dynamic.count"></s:hidden>
