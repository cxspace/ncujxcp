...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered"  method="post" action="${pageContext.request.contextPath}/sys_dynamic_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">评估动态标题</label>

                <div class="col-sm-5">
                    <input type="text" name="dynamic.title" class="form-control" id="field-1" placeholder="请输入评估动态标题">
                </div>
            </div>
