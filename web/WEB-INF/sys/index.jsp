...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <h3>南昌大学本科教学评估网后台管理系统，请您在左侧选择相应管理项</h3>
        ...
        <h5>
            ...
            2、注意创建一个栏目的具体内容后，您可以通过针对改栏目的附件管理，对具体文章做添加附件操作
        ...
        <footer class="main">
            ...
            &copy; 2016 <strong>PowerBy</strong>  <a target="_blank">南昌大学信息工程学院</a>
