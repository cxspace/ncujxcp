...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/sys_advice_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">他山之石标题</label>

                <div class="col-sm-5">
                    <input type="text" name="advice.title" value="<s:property value="advice.title"></s:property>" class="form-control" id="field-1" placeholder="请输入他山之石标题">
                </div>
            </div>

            <br>

            <label class="control-label">他山之石内容</label>

            <br><br>

            <textarea id="editor" name="advice.content" style="width: 100%;height: 360px;">
                <s:property value="advice.content"></s:property>
            </textarea>
            ...
            <s:hidden value="%{advice.id}" name="advice.id"></s:hidden>

            <s:hidden value="%{advice.time}" name="advice.time"></s:hidden>

            <s:hidden value="%{advice.count}" name="advice.count"></s:hidden>
