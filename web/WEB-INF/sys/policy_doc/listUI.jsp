...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_policyDoc_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <s:iterator value="policyDocList" status="st">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_policyDoc_delete.action?policyDoc.id=<s:property value="id"></s:property>" class="btn btn-danger btn-sm btn-icon icon-left">
        ...
        <center>
        <a class="btn btn-default"  href="${pageContext.request.contextPath}/sys_policyDoc_policy_list.action">返回政策法规文件列表</a>
