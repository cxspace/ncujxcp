...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/sys_policyDoc_add.action" enctype="multipart/form-data">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">政策文件标题</label>

                <div class="col-sm-5">
                    <input type="text" class="form-control" name="policyDoc.title" id="title" id="field-1" placeholder="请输入附件标题">
                </div>
            </div>
