...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/sys_inform_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">通知公告标题</label>

                <div class="col-sm-5">
                    <input type="text" name="info.title" value="<s:property value="info.title"></s:property>" class="form-control" id="field-1" placeholder="请输入通知公告标题">
                </div>
            </div>
            ...
            <textarea id="editor" name="info.content" style="width: 100%;height: 360px;">
                <s:property value="info.content"></s:property>
            </textarea>
            ...
            <s:hidden value="%{info.id}" name="info.id"></s:hidden>

            <s:hidden value="%{info.time}" name="info.time"></s:hidden>

            <s:hidden value="%{info.count}" name="info.count"></s:hidden>
