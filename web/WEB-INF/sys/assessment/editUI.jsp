...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/sys_assessment_edit.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">学校自评标题</label>

                <div class="col-sm-5">
                    <input type="text" name="assessment.title" value="<s:property value="assessment.title"></s:property>" class="form-control" id="field-1" placeholder="请输入学校自评标题">
                </div>
            </div>

            <br>

            <label class="control-label">学校自评内容</label>

            <br><br>

            <textarea id="editor" name="assessment.content" style="width: 100%;height: 360px;">
                <s:property value="assessment.content"></s:property>
            </textarea>
            ...
            <s:hidden value="%{assessment.id}" name="assessment.id"></s:hidden>

            <s:hidden value="%{assessment.time}" name="assessment.time"></s:hidden>

            <s:hidden value="%{assessment.count}" name="assessment.count"></s:hidden>
