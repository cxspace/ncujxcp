...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form role="form" class="form-horizontal form-groups-bordered" method="post" action="${pageContext.request.contextPath}/sys_assessment_add.action">

            <div class="form-group">
                <label for="field-1" class="col-sm-3 control-label">学校自评标题</label>

                <div class="col-sm-5">
                    <input type="text" name="assessment.title" class="form-control" id="field-1" placeholder="请输入学校自评标题">
                </div>
            </div>
