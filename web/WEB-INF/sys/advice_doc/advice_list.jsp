        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_adviceDoc_listUI.action?advice.id=<s:property value="id"></s:property>" class="btn btn-default btn-sm btn-icon icon-left">
