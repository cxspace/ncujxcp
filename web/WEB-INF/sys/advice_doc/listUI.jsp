    ...
    <div class="main-content">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <tr>
                ...
                <th>
                    <a href="${pageContext.request.contextPath}/sys_adviceDoc_addUI.action" class="btn btn-info btn-sm btn-icon icon-left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.request.contextPath}/sys_adviceDoc_delete.action?adviceDoc.id=<s:property value="id"></s:property>" class="btn btn-danger btn-sm btn-icon icon-left">
        ...
        <center>
            <a class="btn btn-default" href="${pageContext.request.contextPath}/sys_adviceDoc_advice_list.action">返回它山之石列表</a>
