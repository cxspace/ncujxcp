...
<ul class="list">
    ...
    <s:iterator value="pageResult.items" status="st">
        ...
        <li>
            ...
            <a target="_parent"  href="${pageContext.request.contextPath}/front_inform_info_detail.action?info.id=<s:property value="id"></s:property>"><span><s:property value="time"></s:property></span><s:property value="title"></s:property></a>
        </li>
...
<script language="javascript">
    ...
    function doGoPage(pageNo) {
        document.forms[0].action = "${pageContext.request.contextPath}/front_inform_infoList.action?pageNo="+pageNo;
