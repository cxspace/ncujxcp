...
<div class="title2">
    <h1 style="text-align: center;font-size: 30px;color: black"><s:property value="policy.title"></s:property>
    </h1>
...
<p><s:property value="policy.content" escape="false"></s:property>
</p>


    <s:if test="policyDocList.size()>0">
