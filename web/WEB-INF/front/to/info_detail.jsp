...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <div class="title2">
        ...
        <h1 style="text-align: center;font-size: 30px;color: black"><s:property value="info.title"></s:property>
        </h1>
        <span>浏览次数：<s:property value="info.count"></s:property> </span>
    </div>
    <br/>

<p><s:property value="info.content" escape="false"></s:property>
</p>



    <s:if test="infoDocList.size()>0">
    ...
    <s:iterator value="infoDocList" status="st">
    <p>
        <a href="${pageContext.request.contextPath}/<s:property value="link"></s:property>" style="color: red"> <s:property value="title"></s:property></a>
