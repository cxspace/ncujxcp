...
<div class="title2">
    <h1 style="text-align: center;font-size: 30px;color: black"><s:property value="assessment.title"></s:property>
    </h1><span>浏览次数：<s:property value="assessment.count"></s:property> </span>
</div>

    <br/>

<p><s:property value="assessment.content" escape="false"></s:property>
</p>


    <s:if test="assessmentDocList.size()>0">
    ...
    <s:iterator value="assessmentDocList" status="st">
        <p>
            <a  style="color: red" href="${pageContext.request.contextPath}/<s:property value="link"></s:property>"> <s:property value="title"></s:property></a>
